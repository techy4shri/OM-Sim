...
void TwoConnectedTanks_function_initSynchronous(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
/* Update base-clock. */
void TwoConnectedTanks_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
  TRACE_PUSH
...
int TwoConnectedTanks_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  TRACE_PUSH
  int ret;
...
/* %v% = pre(%v%)*/
void TwoConnectedTanks_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
